...
const EPS=[
  ...
  {g:'Rankings',m:'GET',p:'/rankings/getLeaguesData',d:'Returns leagues data in JSON or RSS format',
   q:[{n:'dataView',l:'dataView',o:['all','teams'],def:'all'},{n:'format',l:'format',o:['json','rss'],def:'json'},{n:'game',l:'game',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeagues/{game}',d:'Get leagues for a specific game',
   pp:[{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueTeams',d:'Get league teams',
   q:[{n:'game',l:'game',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league',t:'text'}]},
  ...
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueTeams/{game}/{league}',d:'Get league teams for a game + league',
   pp:[{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league *',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeaguePreferences/{playerId}',d:'Get league preferences for a player',
   pp:[{n:'playerId',l:'playerId *',t:'text'}],q:[{n:'game',l:'game',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeaguePreferences/{playerId}/{game}',d:'Get league preferences for player + game',
   pp:[{n:'playerId',l:'playerId *',t:'text'},{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']}],q:[{n:'league',l:'league',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeaguePreferences/{playerId}/{game}/{league}',d:'Get specific league preference',
   pp:[{n:'playerId',l:'playerId *',t:'text'},{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league *',t:'text'}]},
  {g:'Rankings',m:'POST',p:'/rankings/setLeaguePreference/{playerId}/{game}/{league}/{preference}',d:'Set league preference for a player',
   pp:[{n:'playerId',l:'playerId *',t:'text'},{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league *',t:'text'},{n:'preference',l:'preference *',t:'text'}],
  ...
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueIndividualRankings/{playerId}/{game}/{league}/{week}',d:'Get league individual rankings for a player',
   pp:[{n:'playerId',l:'playerId *',t:'text'},{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league *',t:'text'},{n:'week',l:'week * (date)',t:'date',def:DATE}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueIndividualRankingsForTeam/{game}/{league}/{teamName}/{week}',d:'Get league individual rankings for a team',
   pp:[{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league *',t:'text'},{n:'teamName',l:'teamName *',t:'text'},{n:'week',l:'week * (date)',t:'date',def:DATE}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueScores',d:'Get league scores',
   q:[{n:'week',l:'week (date)',t:'date'},{n:'game',l:'game',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueScores/{week}',d:'Get league scores for a specific week',
   pp:[{n:'week',l:'week * (date)',t:'date',def:DATE}],q:[{n:'game',l:'game',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueScores/{week}/{game}',d:'Get league scores for a week + game',
   pp:[{n:'week',l:'week * (date)',t:'date',def:DATE},{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']}],q:[{n:'league',l:'league',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getLeagueScores/{week}/{game}/{league}',d:'Get league scores for week + game + league',
   pp:[{n:'week',l:'week * (date)',t:'date',def:DATE},{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']},{n:'league',l:'league *',t:'text'}]},
  {g:'Rankings',m:'GET',p:'/rankings/getWeeklyResultsForTeam/{game}/{leagueName}/{teamName}',d:'Get weekly results for a team',
   pp:[{n:'game',l:'game *',o:['Sportsbook','Influencer HQ']},{n:'leagueName',l:'leagueName *',t:'text'},{n:'teamName',l:'teamName *',t:'text'}]},
