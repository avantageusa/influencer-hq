<?php
/**
 * Template Name: Influencer HQ NEW
 * Description: A custom template for displaying the influencer HQ new.
 * This template is used to render the influencer HQ new content and layout.
 *
...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section class="hero-section ">
            ...
            <!-- TAB 6: <?php echo is_user_logged_in() ? 'INFLUENCER HQ' : 'LOGIN/REGISTER'; ?> -->
            <div class="tab-pane fade show active" id="tab6" role="tabpanel" aria-labelledby="tab6-tab">
                <div class="hero-tab-content-wrapper row">
                    <?php if (is_user_logged_in()) : ?>
                        <!-- User is logged in - Show Influencer HQ -->
                        <div class="text-center mb-4">
                            <h1 class="text-28pt fw-bold text-yellow mb-3">WELCOME TO INFLUENCER HQ — Your Creator Command Center</h1>
                        </div>
                                ...
                                <div class="hero-tab-content-wrapper row">
                                    ...
                                    <div class="text-center mt-5">
                                        <button class="btn btn-warning btn-lg px-5 py-3" onclick="activateTabByHash('login')" style="background-color: #ffc107; border-color: #ffc107; color: #000; font-weight: bold;">
                                            Next Tab: <?php echo is_user_logged_in() ? 'INFLUENCER HQ' : 'LOGIN/REGISTER'; ?>
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="tab-pane fade" id="tab6" role="tabpanel" aria-labelledby="tab6-tab">
                <div class="hero-tab-content-wrapper row">
                    <?php if (is_user_logged_in()) : ?>
                        ...
                        <div class="text-start" style="max-width: 1000px; margin: 0 auto; line-height: 1.6;">
                            <p class="fs-5 text-light-gray mb-4">This is where you activate your equity, set up your Challenges, stream on Kick, and lead your community.</p>
                            
                            <p class="fs-5 text-light-gray mb-5">Your email is verified. Your Creator Toolkit is unlocked. Let's begin.</p>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Quick-Start Checklist -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Quick-Start Checklist</h2>
                            <ol class="fs-5 text-light-gray mb-5">
                                <li class="mb-2">Set your Leaderboard Name</li>
                                <li class="mb-2">Get your Genius Equity Tracking Link</li>
                                <li class="mb-2">Create your first Challenge</li>
                                <li class="mb-2">Invite your community</li>
                                <li class="mb-2">Stream on Kick (optional)</li>
                                <li class="mb-2">Track your growth in real time</li>
                            </ol>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Leaderboard Name -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Leaderboard Name</h2>
                            <p class="fs-5 text-light-gray mb-3">This is the name that will appear on your Challenge leaderboards, community pages, and anywhere your results are displayed.</p>
                            <p class="fs-5 text-light-gray mb-3">This name will be automatically attached to all your Challenges and will appear on every leaderboard where you are ranked.</p>
                            <p class="fs-5 text-light-gray mb-4">Enter the name you want your followers and the world to see.</p>
                            
                            <!-- Leaderboard Name Field -->
                            <div class="mb-5">
                                <input type="text" class="form-control form-control-lg" id="leaderboard_name" name="leaderboard_name" 
                                       style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 15px; max-width: 500px;"
                            ...
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Create Your First Challenge</h2>
                            <p class="fs-5 text-light-gray mb-4">All dates and times in this section use Hong Kong Time (HKT).</p>
                            <p class="fs-5 text-light-gray mb-4">Choose the Challenge format you want to lead:</p>
                            <ul class="fs-5 text-light-gray mb-5">
                                <li class="mb-2">Influencer + Community Challenge</li>
                                <li class="mb-2">International Weekend Challenge (activates after internal testing is complete)</li>
                            </ul>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Influencer + Community Challenge -->
                            <h3 class="text-20pt fw-bold text-yellow mb-4">Influencer + Community Challenge</h3>
                            <p class="fs-5 text-light-gray mb-3">Your followers participate together to lift your leaderboard ranking.</p>
                            <p class="fs-5 text-light-gray mb-4">You can schedule a Challenge for today, tomorrow, or any future date.</p>
                            
                            <p class="fs-5 text-light-gray mb-3">You'll choose:</p>
                            <ul class="fs-5 text-light-gray mb-4">
                                <li class="mb-2">Start Date</li>
                                <li class="mb-2">Start Time (24-hour time, displayed as 17:00 HKT (5 PM))</li>
                                <li class="mb-2">Challenge Duration (1–48 hours)</li>
                                <li class="mb-2">Optional instructions</li>
                                <li class="mb-2">Optional Kick streaming times at any hour</li>
                            </ul>
                            
                            <p class="fs-5 text-light-gray mb-5">Your End Time is calculated automatically based on your chosen Duration.</p>
                            
                            <!-- Challenge Builder Form -->
                            <div class="challenge-builder mb-5" style="background: rgba(33, 37, 41, 0.4); border: 1px solid rgba(255, 149, 0, 0.3); border-radius: 10px; padding: 30px;">
                                <form id="community-challenge-form">
                                    <div class="mb-4">
                                        <label class="form-label fs-5 text-light-gray mb-2">Start Date</label>
                                        <input type="date" class="form-control form-control-lg" 
                                               style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 15px; max-width: 300px;">
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label class="form-label fs-5 text-light-gray mb-2">Start Time (HKT)</label>
                                        <select class="form-select form-select-lg" 
                                                style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 15px; max-width: 200px;">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fs-5 text-light-gray mb-2">Challenge Duration</label>
                                        <select class="form-select form-select-lg" 
                                                style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 15px; max-width: 200px;">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fs-5 text-light-gray mb-2">Instructions (Optional)</label>
                                        <textarea class="form-control" rows="4" 
                                                  style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 15px;"
                                                  placeholder="Add any special instructions for your community..."></textarea>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label class="form-label fs-5 text-light-gray mb-3">Kick Streaming Times (Optional)</label>
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label text-light-gray">Friday</label>
                                                <select class="form-select" 
                                                        style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 10px;">
                                                    <option value="">Not streaming</option>
                                                    <?php for($i = 0; $i < 24; $i++): ?>
                                                        <option value="<?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?>"><?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?>:00</option>
                                                    <?php endfor; ?>
                                                </select>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label text-light-gray">Saturday</label>
                                                <select class="form-select" 
                                                        style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 10px;">
                                                    <option value="">Not streaming</option>
                                                    <?php for($i = 0; $i < 24; $i++): ?>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label text-light-gray">Sunday</label>
                                                <select class="form-select" 
                                                        style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 10px;">
                                                    <option value="">Not streaming</option>
                                                    <?php for($i = 0; $i < 24; $i++): ?>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fs-5 text-light-gray mb-2">Auto-Calculated End Time</label>
                                        <input type="text" class="form-control form-control-lg" readonly 
                                               style="background: rgba(33, 37, 41, 0.6); border: 2px solid rgba(255, 149, 0, 0.5); color: #aaa; padding: 15px; max-width: 300px;"
                            ...
                            <!-- International Weekend Challenge -->
                            <h3 class="text-20pt fw-bold text-yellow mb-4">International Weekend Challenge</h3>
                            <p class="fs-5 text-light-gray mb-3">A synchronized global event that always runs:</p>
                            <p class="fs-5 text-yellow fw-bold mb-4">Friday 17:00 HKT (5 PM) → Sunday 17:00 HKT (5 PM)</p>
                            <p class="fs-5 text-light-gray mb-3">Your community joins creators around the world.</p>
                            <p class="fs-5 text-light-gray mb-3">You choose which weekend you want.</p>
                            <p class="fs-5 text-light-gray mb-4">Kick streaming times remain optional.</p>
                            
                            <div class="alert alert-warning mb-5" style="background: rgba(255, 149, 0, 0.2) !important; border: 2px solid rgba(255, 149, 0, 0.6) !important; color: var(--light-gray) !important;">
                                <p class="fs-5 mb-0"><strong>International Weekend Challenge</strong><br>(Activates after internal testing is complete.)</p>
                            </div>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Referral Summary -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Referral Summary</h2>
                            <div class="callout-box mb-5">
                                <p class="fs-5 text-light-gray mb-0">Your referral and community activity will appear here.</p>
                            </div>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Your Tracking Link -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Your Tracking Link</h2>
                            <div class="mb-5">
                                <label class="form-label fs-5 text-light-gray mb-2">Your permanent link that connects your followers' participation to your account.</label>
                                <input type="text" class="form-control form-control-lg" readonly 
                                       style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 15px;"
                                       value="Your Tracking Link will appear here" placeholder="Your Tracking Link:">
                            </div>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Challenge Links -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Challenge Links</h2>
                            <div class="callout-box mb-5">
                                <p class="fs-5 text-light-gray mb-0">Your Challenge Links will appear here.</p>
                            </div>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Messaging Templates -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Messaging Templates</h2>
                            <p class="fs-5 text-light-gray mb-4">Templates to rally your community:</p>
                            
                            <div class="mb-4">
                                <label class="form-label fs-5 text-yellow mb-2">Community Challenge Invitation</label>
                                <textarea class="form-control" rows="4" readonly 
                                          style="background: rgba(33, 37, 41, 0.6); border: 2px solid rgba(255, 149, 0, 0.5); color: #fff; padding: 15px;"
                                          placeholder="Template will appear here"></textarea>
                            </div>
                            
                            <div class="mb-4">
                                <label class="form-label fs-5 text-yellow mb-2">International Weekend Invitation</label>
                                <textarea class="form-control" rows="4" readonly 
                                          style="background: rgba(33, 37, 41, 0.6); border: 2px solid rgba(255, 149, 0, 0.5); color: #fff; padding: 15px;"
                                          placeholder="Template will appear here"></textarea>
                            </div>
                            ...
                            <div class="mb-5">
                                <label class="form-label fs-5 text-yellow mb-2">General Invite Message</label>
                                <textarea class="form-control" rows="4" readonly 
                                          style="background: rgba(33, 37, 41, 0.6); border: 2px solid rgba(255, 149, 0, 0.5); color: #fff; padding: 15px;"
                                          placeholder="Template will appear here"></textarea>
                            </div>
                            ...
                            <!-- Your Influencer Page -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Your Influencer Page</h2>
                            <div class="callout-box mb-5">
                                <p class="fs-5 text-light-gray mb-0">Your Influencer Page launches this week — your page showing your Kick schedule, Challenges, and results.</p>
                            </div>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Kick Streaming Setup Guide -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Kick Streaming Setup Guide</h2>
                            <p class="fs-5 text-light-gray mb-4">A simple guide for starting your Kick stream, adding your Challenge links, and engaging your community.</p>
                            <p class="fs-5 text-light-gray mb-5">You may stream at any time — play-along and referrals count whether or not you run a Challenge.</p>
                            <div class="mb-5">
                                <a href="#" class="btn btn-outline-warning btn-lg px-4 py-2">Kick Streaming Guide (PDF)</a>
                            </div>
                            
                            <hr class="section-divider text-light-gray mb-5">
                            
                            <!-- Support & Communication -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Support & Communication</h2>
                            <p class="fs-5 text-light-gray mb-4">Choose how you want us to communicate with you:</p>
                            
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light-gray">WhatsApp Number</label>
                                    <input type="text" class="form-control" 
                                           style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 12px;"
                                           placeholder="Your WhatsApp">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light-gray">LINE ID or Number</label>
                                    <input type="text" class="form-control" 
                                           style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 12px;"
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light-gray">Telegram Number</label>
                                    <input type="text" class="form-control" 
                                           style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 12px;"
                                           placeholder="Your Telegram">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light-gray">Instagram Handle (Optional)</label>
                                    <input type="text" class="form-control" 
                                           style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 12px;"
                            ...
                            <div class="row mb-5">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light-gray">TikTok Handle (Optional)</label>
                                    <input type="text" class="form-control" 
                                           style="background: rgba(33, 37, 41, 0.8); border: 2px solid #ffc107; color: #fff; padding: 12px;"
                            ...
                            <div class="text-center mb-5">
                                <button class="btn btn-warning btn-lg px-5 py-3" 
                                        style="background-color: #ffc107; border-color: #ffc107; color: #000; font-weight: bold;">
                            ...
                            <!-- Genius Referrals Note -->
                            <h2 class="text-22pt fw-bold text-yellow mb-4">Genius Referrals</h2>
                            <div class="pro-tip mb-5">
                                <p class="fs-5 text-light-gray mb-0"><strong>Note for Developer (Milos):</strong> Before building equity displays, export ALL Genius Referrals fields, variables, event names, and JSON/API objects. Send them to Marcus as plain text.</p>
                            </div>
                        </div>
