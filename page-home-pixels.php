...
?>
    ...
    <main id="primary" class="site-main">
            ...
            <div class="container">
                <div class="row">
                    <div class="vh-60 col-12 fade-in text-center align-middle hero-content">
                        ...
                        <p class="hero-subtitle" style="font-size: 22px !important; line-height: 28px !important;">— OWN THE FUTURE —</p>
                        <h1 class="text-center hero-title" style="font-size: 22px !important; line-height: 28px !important; font-weight: 700 !important;">Influence… Compete… and Own the Future</h1>
                        
                        <div class="hero-beliefs-container">
                            <p class="hero-intro" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">People don't buy what you do.</p>
                            <p class="hero-intro" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 28px !important;">They buy what you believe.</p>
                            
                            <div class="beliefs-list">
                                <p class="belief-item" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">We believe influence deserves more than short-term payouts.</p>
                                <p class="belief-item" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">We believe your voice should create long-term value.</p>
                                <p class="belief-item" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 28px !important;">We believe those who drive the energy deserve to share in what they help build.</p>
                            </div>
                            
                            <p class="hero-closing" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">These beliefs guide every opportunity represented through Influencer Headquarters, where influencers partner with global platforms that value long-term contribution — not one-time campaigns.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Competition section-->
        <section id="competition" class="py-5 fade-in-on-scroll" style="padding-top: 28px !important; padding-bottom: 28px !important;">
            <div class="container">
                <h2 class="section-heading mb-5" style="font-size: 32px !important; line-height: 38px !important; margin-bottom: 28px !important;">The Future of the Influencer Marketplace</h2>
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Brands everywhere rely on influencers to shape culture, spark engagement, and build communities.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">But traditional partnerships often end sooner than the value you provide.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">We believe in a different path:</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">When your influence grows a platform, you should share in the long-term value created by that growth.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Our partners' platforms are designed to reward sustained contribution, giving influencers a meaningful stake in the success they help build.</p>
                        <p class="lead mb-5" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">As these ecosystems expand across new markets and categories, the value of your influence grows with them.</p>
                    </div>
                </div>
            </div>
        </section>        
                <section id="how-you-earn" class="py-5 fade-in-on-scroll" style="padding-top: 28px !important; padding-bottom: 28px !important;">
            <div class="container">
                 <h2 class="section-heading mb-5" style="font-size: 32px !important; line-height: 38px !important; margin-bottom: 28px !important;">A Lesson from History</h2>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6">
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">In 1979, Converse offered college basketball star Magic Johnson what seemed like a fortune: $100,000 — guaranteed cash.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Nike, a newcomer on the scene, offered something different: 1 cent for every shoe sold, plus stock then valued at just 11 cents per share.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Magic took the cash.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">That stock offer — the one he passed — would be worth more than $5 billion today.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">We believe influencers should have the opportunity to share in the ownership moment Magic missed.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">TikTok star Alix Earle chose an ownership-based partnership with Poppi instead of a traditional cash sponsorship.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">When Poppi was soon acquired by PepsiCo for over a billion dollars, her choice became a defining moment in the creator economy.</p>
                        <p class="lead mb-0" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Ownership matters — and influence deserves the chance to share in it.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="game-of-kings" class="py-5 fade-in-on-scroll" style="padding-top: 28px !important; padding-bottom: 28px !important;">
            <div class="container">
                <h2 class="section-heading mb-5" style="font-size: 32px !important; line-height: 38px !important; margin-bottom: 28px !important;">Competition: The Oldest Language in the World</h2>
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">From the earliest days of civilization, competition has united people across cultures.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">It began in ancient Greece, where the first Olympic Games ignited national pride.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">It filled the arenas of Rome, where crowds gathered for courage, skill, and spectacle.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">It lives in Asia's legendary traditions — games of mastery, precision, rhythm, and strategy celebrated for centuries.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Today, competition fuels:</p>
                        
                        <div class="row g-3 mb-4 justify-content-center" style="margin-bottom: 28px !important;">
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="competition-item">
                                    <div class="competition-text" style="font-size: 17px !important; line-height: 26px !important;">Global Sports</div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="competition-item">
                                    <div class="competition-text" style="font-size: 17px !important; line-height: 26px !important;">Music Battles</div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="competition-item">
                                    <div class="competition-text" style="font-size: 17px !important; line-height: 26px !important;">Esports Arenas</div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="competition-item">
                                    <div class="competition-text" style="font-size: 17px !important; line-height: 26px !important;">Creator Challenges</div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="competition-item">
                                    <div class="competition-text" style="font-size: 17px !important; line-height: 26px !important;">Digital Tournaments</div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="competition-item">
                                    <div class="competition-text" style="font-size: 17px !important; line-height: 26px !important;">Moments We Share Together</div>
                                </div>
                            </div>
                        </div>
                        
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Competition is universal.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Competition is emotional.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Competition is human.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Throughout history, competition has always needed leaders — voices who elevate every moment, ignite anticipation, and unite communities.</p>
                        <p class="lead mb-5" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Today, those leaders are influencers.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="how-you-earn-section" class="py-5 fade-in-on-scroll" style="padding-top: 28px !important; padding-bottom: 28px !important;">
            <div class="container">
                <h2 class="section-heading mb-5" style="font-size: 22px !important; line-height: 28px !important; margin-bottom: 28px !important;">Elegance. Prestige. Global Legacy.</h2>
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">The stages influencers step onto today carry the same timeless elements found in the world's greatest competitions:</p>
                        <ul class="lead mb-4" style="list-style: none; padding-left: 0; margin-bottom: 28px !important;">
                            <li class="mb-3" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Elegance that never goes out of style</li>
                            <li class="mb-3" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Prestige that spans centuries</li>
                            <li class="mb-3" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">A global following that crosses borders and cultures</li>
                            <li class="mb-3" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Intensity and emotion in every moment</li>
                        </ul>
                        <p class="lead mb-5" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Influence deserves a stage worthy of that legacy — and now, it has one.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="global-exposure" class="py-5 fade-in-on-scroll" style="padding-top: 28px !important; padding-bottom: 28px !important;">
            <div class="container">
                <h2 class="section-heading mb-5" style="font-size: 32px !important; line-height: 38px !important; margin-bottom: 28px !important;">International Competition Series — A 24-Hour Global Stage</h2>
                
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Influencers and streamers who deliver outstanding engagement are invited to appear on our partners' International Competition Series — a 24-hour global stage being introduced to highlight top creators from around the world.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">Each broadcast showcases competitions from around the world, with creators appearing together from their own locations, sharing their reactions, commentary, and competitive energy in real time.</p>
                        <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">When your followers watch you play, cheer, and celebrate, they become part of a shared experience that unites people the same way great sports, music, and global competitions always have.</p>
                        <p class="lead mb-5" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">This is what influence looks like when it comes alive.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Form section -->
        <section id="contact-form" class="py-5 fade-in-on-scroll" style="padding-top: 28px !important; padding-bottom: 28px !important;">
            <div class="container">
                <h2 class="section-heading mb-5" style="font-size: 32px !important; line-height: 38px !important; margin-bottom: 28px !important;">Start the Conversation</h2>
                    ...
                    <div class="col-lg-8">
                        ...
                        ?>
                            <form id="avantage-form" class="simple-form">
                                        ...
                                        <div class="mb-4">
                                            <p class="lead mb-4" style="font-size: 17px !important; line-height: 26px !important; margin-bottom: 14px !important;">If you believe you're ready to lead, choose the method(s) you'd like us to use to communicate with you:</p>
                                        </div>
                                        
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="checkbox" name="comm_methods[]" value="line" id="line">
                                            <label class="form-check-label" for="line" style="font-size: 17px !important; line-height: 26px !important;">LINE</label>
                                        </div>
                                        
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="checkbox" name="comm_methods[]" value="telegram" id="telegram">
                                            <label class="form-check-label" for="telegram" style="font-size: 17px !important; line-height: 26px !important;">Telegram</label>
                                        </div>
                                        
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="checkbox" name="comm_methods[]" value="whatsapp" id="whatsapp">
                                            <label class="form-check-label" for="whatsapp" style="font-size: 17px !important; line-height: 26px !important;">WhatsApp</label>
                                        </div>
                                        
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="checkbox" name="comm_methods[]" value="wechat" id="wechat">
                                            <label class="form-check-label" for="wechat" style="font-size: 17px !important; line-height: 26px !important;">WeChat</label>
                                        </div>
...
<style>
   ...
   .hero-section {
    position: relative;
    background: url('<?php echo get_template_directory_uri(); ?>/images/hero-bgnd.jpg') center center no-repeat;
